...
export const PROJECTS = [
    {
        ...
        description: 'The International Will Registry is a secure, Next.js-based web application that helps users register and manage the location of their wills and important estate documents, ensuring they can be easily found by trusted representatives when needed.',
